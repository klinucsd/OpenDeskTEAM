...
<%
	 ...
	 if (photo != null) {
	     ...
	     out.println("   img_array: 'Array"+photo.getCollection().getCameraTrap().getBlock().getIndex()+"',");
		...
		if (type.equals("Animal")) {
		    ...
		    PhotoSpeciesRecord record = (PhotoSpeciesRecord)itor.next();
		    ...
		    if (records.size() == 2) {
		        record = (PhotoSpeciesRecord)itor.next();
		    	out.println("   img_genus2: '"+record.getGenus()+"',");		    
		    	out.println("   img_species2: '"+record.getSpecies()+"',");
		    	out.println("   img_number2: '"+record.getNumberOfAnimals()+"',");
		    }		    		    
		}
