...
<%
     ...
     if (trapName != null && event != null && raw != null) {    
         ...
         Set<CameraTrapPhoto> gallery = network.getCameraTrapPhotoCluster(photo);
	 
	 CameraTrapPhoto first = null;
	 ...
	 photo = network.getPreviousCameraTrapPhoto(first);
	 if (photo != null) {

	     gallery = network.getCameraTrapPhotoCluster(photo);
	     photo = gallery.iterator().next();
